...
const DOMAINS: Domain[] = [
  ...
  },
  {
    ...
    tag: "Telecom VAS",
    title: "통신사 부가서비스",
    subtitle: "통신 기반 구독 서비스로 투자 정보를 혁신합니다",
    color: "text-sky-400",
    bgGradient: "from-sky-900/40 to-brand-primary/60",
    desc: "SKT 공식 파트너로서 이동통신 요금과 통합 청구되는 프리미엄 구독 서비스를 제공합니다. 해외주식노트와 부동산경매노트로 투자 정보의 새로운 패러다임을 열어갑니다.",
    capabilities: [
      { title: "해외주식노트 — 일일 리포트",  detail: "하루 3회 미국 주식 핵심 종목 분석 리포트 제공" },
      { title: "종목 분석 & 투자 전략",       detail: "매수가·목표가·손절가 명확한 투자 정보 제공" },
      { title: "시장 뉴스 큐레이션",          detail: "전문가가 엄선한 미국 증시 뉴스 & 일정 요약" },
      { title: "부동산경매노트 — 일 2회 추천", detail: "오전·오후 빅데이터 기반 경매 물건 문자 배송" },
      { title: "권리분석 & 낙찰가 예상",      detail: "전문 리서치팀의 법적 검토 및 낙찰 예상가 제공" },
      { title: "경공매 전문가 의견",          detail: "20년 이상 전문가의 심층 투자 인사이트 제공" },
    ],
    industries: [
      { name: "통신",     icon: Globe        },
      { name: "금융",     icon: Landmark     },
